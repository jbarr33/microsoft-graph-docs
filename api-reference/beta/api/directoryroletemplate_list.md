...
<!-- {
  ...
  "tocPath": "/beta reference/Directory/directory role template/List directoryRoleTemplates",
  "apiVersion": "beta",
  "section": "documentation",
  "canonicalURL": "/en-us/api-reference/v1.0/api/directoryroletemplate_list"
} -->
